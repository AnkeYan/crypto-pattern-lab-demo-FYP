...
python3 scripts/analyze_active_addresses.py >> /tmp/crypto-pattern-lab-update.log 2>&1
python3 scripts/analyze_mvrv.py >> /tmp/crypto-pattern-lab-update.log 2>&1
python3 scripts/analyze_btc_dominance.py >> /tmp/crypto-pattern-lab-update.log 2>&1
python3 scripts/analyze_hmm_regime.py >> /tmp/crypto-pattern-lab-update.log 2>&1
python3 scripts/analyze_turbulence.py
python3 scripts/analyze_portfolio_optimization.py >> /tmp/crypto-pattern-lab-update.log 2>&1
